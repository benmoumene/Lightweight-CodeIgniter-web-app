  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Liste des dépenses</li>
      </ol>
    </section>
	  ...
	  <div class="col-xs-12">
	    <div class="row clearfix" style="padding-bottom: 4px;margin-bottom: 5px">
		  <div class="col-md-12 column">
            <a id="modal-666931" href="#modal-container-666931" role="button" class="btn bg-maroon btn-flat btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Nouvelle dépense</a>&nbsp;
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form" id="addItem" action="<?php echo base_url().'categorielist/add_categorie' ?>" method="POST">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Raison</label>
                              <div class="col-sm-9">
							                     <input type="text" class="form-control" name="raison" id="raison" placeholder="Raison de la dépense">
                              </div>
                            </div>
                            <div class="form-group">
...
$('.btn_delete').on('click', function(e) {
        ...
        var delfun = function(){
            var url = '<?php echo base_url() ?>depenselist/delete_depense';
            var data = delid
            $.ajax({
                url: url,
                type:"POST",
