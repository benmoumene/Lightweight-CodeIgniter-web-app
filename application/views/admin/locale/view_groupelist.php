				...
				$sno = 1; ?>
						...
						<td>
							<?php 
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a  db_id ='<?php echo $row->id ?>' href="<?php echo base_url() ?>Categorielist/load_edit_view/<?=$row->id?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
