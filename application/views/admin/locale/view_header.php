...
<html>
    <head>
        ...
        <title>LyCoP/tableau de bord</title>
		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default navbar-inverse navbar-fixed-top" role="navigation">
				<div class="navbar-header">
                                    ...
                                    <a class="navbar-brand" href="<?php echo base_url().'dashbord'?>"><strong>Planification</strong></a>
				</div>
				
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
                                            <li><a href="<?php echo base_url() ?>"><strong>Lycée d'Ahépé </strong></a></li>
                                            <li><a href="<?php echo base_url().'dashbord'?>"><strong>Tableau de bord</strong></a></li>
                                            <li><a  href="<?php echo base_url().'articlelist' ?>"><strong>articles</strong></a></li>
											<li><a  href="<?php echo base_url().'Categorielist' ?>"><strong>Classes</strong></a></li>
                                            <li><a  href="<?php echo base_url().'Categorielist' ?>"><strong>Cours</strong></a></li>
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li>
                                                                    <a href="<?php echo base_url() ?>admin/logout"><small><i class="glyphicon glyphicon-off"></i></small>&nbsp;&nbsp;Déconnexion</a>
								</li>
							</ul>
						</li>
					</ul>
                                       <?php if($this->session->userdata('role') == 'admin'):?>
                                        <ul class="nav navbar-nav navbar-right">
						<li class="dropdown">
                                                    <a style="margin-right: 15px;" href="#" class="dropdown-toggle" data-toggle="dropdown"><b>PARAMETRE</b><strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									<a href="#"><small><i class="glyphicon glyphicon-pencil"></i></small>&nbsp;&nbsp;Changer de mot de Passe</a>
								</li>
