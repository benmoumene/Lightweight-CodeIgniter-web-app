      ...
      <div class="box">
            ...
            <div class="box-body">
			   <table id = "example2" class="table display">
				<thead>
				<tr>
				<th></th><th>Nom du Categorie</th><th>Dîmes</th><th>Offrandes</th><th>Dons</th>
				<th>Total</th>
				</tr>
				</thead>
				<tbody>
...
function format ( d ) {
  ...
  $(function () {
    var dt = $('#example2').DataTable({
      "ajax":{"url":"<?php echo base_url() ?>dashbord/fetchMasterDetailventee",
	  "dataSrc":""},
      "paging": true,
      "lengthChange": false,
      "searching": true,
	  ...
	  "columns": [
            ...
            { "data": "name" },
            { "data": "total_dime_Categorie" },
            { "data": "total_offrande_Categorie" },
            { "data": "total_don_Categorie"},
			{ "data": "total_Categorie"}
        ],
		"order": [[1, 'desc']]
    });
