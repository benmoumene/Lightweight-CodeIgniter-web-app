	...
	<div class="row clearfix">
	  <div class="col-xs-12">
		...
		<div class="col-md-12 column">
                        <a id="modal-666931" href="#modal-container-666931" role="button" class="btn bg-maroon btn-flat btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Ajouter un nouveau article</a>&nbsp;
				...
				<tbody><?php $sno = 1; ?>
						...
						<td>
							<?php echo $row->categorie_name ?>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a  db_id ='<?php echo $row->id ?>' href="<?php echo base_url() ?>articlelist/load_edit_view/<?=$row->id?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" role="form" id="addItem" action="<?php echo base_url().'articlelist/add_article' ?>" method="POST">
                          <div class="form-group">
                              <label class="col-sm-3 control-label">No de compte</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="nocompte" id="nocompte" placeholder="No de compte">
                              </div>
                            </div>
						  <div class="form-group">
                              <label class="col-sm-3 control-label">Nom du article</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" id="name" placeholder="Nom du article">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Code du article</label>
                              <div class="col-sm-9">
							  <input type="text" class="form-control" name="code" id="code" placeholder="Code du article">
                              </div>
                            </div>
							<div class="form-group">
							    <label class="col-sm-3 control-label">Sélectionner le Categorie</label>
                                <div class="col-sm-9">
