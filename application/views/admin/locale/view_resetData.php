                ...
                <h3>
                    ...
                    <p>
                        <b>  After reset process all the item and also transaction will be deleted.<br>
                            ...
                            We suggest <a href="<?php echo base_url() ?>articlelist/">export excel</a><br> and <a href="<?php echo base_url() ?>dashbord/">export transaction</a> file also before Reset process ! thanks
                        </b>
                    </p>
                <p>
