  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Paramètres</li>
		<li class="active">Liste des types de ventes</li>
      </ol>
    </section>
	  ...
	  <div class="col-xs-12">
		...
		<div class="col-md-12 column">
                    <div class="col-sm-4 clearfix">
                        <a id="modal-666931" href="#modal-container-666931" role="button" class="btn bg-maroon btn-flat btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i>Ajouter un nouveau type de vente</a>&nbsp;
                    </div>
				...
				$sno = 1; ?>
						...
						<td>
							<?php 
                                                        ...
                                                        echo strftime("%d %B %Y", $created );?>
						</td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a  db_id ='<?php echo $row->id ?>' href="<?php echo base_url() ?>typeventelist/load_edit_view/<?=$row->id?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Edit"><i class="glyphicon glyphicon-pencil"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Ajouter un type de vente</h4>
                    </div>

                    <div class="modal-body">
                        <div id='ret'></div>
                        
                        <form class="form-horizontal" role="form" id="addItem" action="<?php echo base_url().'typeventelist/add_typevente' ?>" method="POST">
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Nom du type de vente</label>
                              <div class="col-sm-9">
...
$('.btn_delete').on('click', function(e) {
        ...
        var delfun = function(){
            var url = '<?php echo base_url() ?>typeventelist/delete_typevente';
            var data = delid
            $.ajax({
                url: url,
                type:"POST",
