    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       <li><a href="<?php echo base_url().'dashbord'?>">Tableau de bord</a></li>
            <li class=""><a href="<?php echo base_url().'typeventelist'?>">Liste des types de vente</a></li></li>
            <li class="active">Modifier type de vente</li>
      </ol>
	  <div id="ret">
		...
		<div class="col-md-12 column">
                    <form class="form-horizontal" role="form" id="editItem" action="<?php echo base_url().'articlelist/do_edit' ?>" method="POST">
                        ...
                        <div class="form-group">
                              <label class="col-sm-3 control-label">Nom type de vente</label>
                              <div class="col-sm-9">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
							  <input type="text" class="form-control" name="prenoms" id="prenoms" value="<?=$row->code?>">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-9">
                                  ...
                                  <a href="<?php echo base_url().'typeventelist'?>" class="btn btn-info">Annuler</a>
                              </div>
                            </div>
                          <?php endforeach; ?>
                        </form>
