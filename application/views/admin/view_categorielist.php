	  ...
	  <div class="col-xs-12">
	    <div class="row clearfix" style="padding-bottom: 4px;margin-bottom: 5px">
		  <div class="col-md-12 column">
            <a id="modal-666931" href="#modal-container-666931" role="button" class="btn bg-maroon btn-flat btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Nouvelle categorie</a>&nbsp;
		...
		<div class="box">
            ...
            <td>
            <div href="#" class="container" style="text-align:left; width: 80px; height: 55px;">
              <img style="width: 100%; height: auto;" src="<?php echo base_url() ?><?=$row->CATEG_IMG_URL ?>" class="img-circle categ_img" alt="">
            </div>
            </td>
            <td>
              <?=$row->CATEG_CODE ?>
						...
						<td>
							<?=$row->CATEG_DESIGNATION?>
						</td>
						<td>
							<?php echo $row->CATEG_PRIX_UNITAIRE ?>
						</td>

                                                <td>
                                                    <div class="btn-group">
                                                        <a  db_id ='<?php echo $row->id ?>' href="<?php echo base_url() ?>categorielist/load_edit_view/<?=$row->CATEG_ID?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Modifier"><i class="glyphicon glyphicon-pencil"></i></a>
                                                        <a db_id='<?php echo $row->CATEG_ID ?>' href="#delete" class="btn btn-default btn-sm btn_delete" title="Supprimer"><i class="glyphicon glyphicon-remove"></i></a>
                                                     </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id='ret'></div>
                            ...
                            //$attributes = array('class' => 'form-horizontal', 'id' => 'addItem', 'role' => 'form');
                            //$url= base_url();
                            echo form_open_multipart('categorielist/add_categorie', array('class' => 'form-horizontal'));

                            echo '<div class="form-group">
                                  <label class="col-sm-3 control-label">Code de catégorie</label>
                                  <div class="col-sm-9">';

                            $code = array(
                                          'name'        => 'code',
                                          'id'          => 'code',
                                          'placeholder'       => 'Code de catégorie',
                                          'class'        => 'form-control'
                                        );
                        ...
                        <!--form class="form-horizontal" role="form" id="addItem" action="<?php //echo base_url().'categorielist/add_categorie' ?>" method="POST">
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Code de catégorie</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="code" id="code" placeholder="Code de catégorie">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="col-sm-3 control-label">Libellé</label>
                              <div class="col-sm-9">
							                     <input type="text" class="form-control" name="designation" id="designation" placeholder="Libellé de catégorie">
                              </div>
                            </div>
							              <div class="form-group">
                              <label class="col-sm-3 control-label">Prix unitaire</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="remise" id="remise" placeholder="Remise">
                              </div>
                            </div>
                            <div class="form-group">
...
<div class="modal fade" id="img_modal" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
...
<script>
$('.categ_img').on('click', function(e) {
        e.preventDefault();
        var url = $(this).attr('src');
        $('#img_modal').modal('show');
        $("#img").html('<img src='+url+' class="user-image categ_img" alt="User Image">');
 });
</script>
