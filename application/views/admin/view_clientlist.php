	...
	<div class="row clearfix">
	  <div class="col-xs-12">
		...
		<div class="col-md-12 column">
                        <a id="modal-666931" href="#modal-container-666931" role="button" class="btn bg-maroon btn-flat btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Nouveau Client</a>&nbsp;
		...
		<div class="box">
            ...
            <th>
				...
				$sno = 1; ?>
						...
						<td>
							<h5><strong><?=$row->CLI_NOM ?></strong></h5>
						</td>						
            <td>
              <h5><strong><?=$row->CLI_PRENOM ?></strong></h5>
            </td>
            <td>
              <h5><strong><?=$row->CLI_CREATED?></strong></h5>
            </td>
            <td>
              <h5><strong><?=$row->CLI_TEL1 ?></strong></h5>
            </td>           
            <td>
              <h5><strong><?=$row->CLI_WHATSAPP ?></strong></h5>
            </td>
            <td style="text-align: right; color:#0080ff; font-weight: bold;">
              <h5><strong><?=$row->VENTE_TOTALE ?></strong></h5>
            </td>
            <td style="text-align: right; color: red; font-weight: bold;">
              <h5><strong><?=$row->RESTE_TOTAL ?></strong></h5>
            </td>
            ...
            <td>
                <div class="btn-group">
                  <a  db_id ='<?php echo $row->CLI_ID ?>' href="<?php echo base_url() ?>clientlist/load_edit_view/<?=$row->CLI_ID?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Profil"><i class="fa fa-eye"></i></a>
                    <a  db_id ='<?php echo $row->CLI_ID ?>' href=""  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Règlements"><i class="fa fa-money"></i></a>
                    <a  db_id ='<?php echo $row->CLI_ID ?>' href="<?php echo base_url() ?>clientlist/load_situation_view/<?=$row->CLI_ID?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Situation"><i class="fa fa-male"></i></a>
                    <a db_id='<?php echo $row->CLI_ID ?>' href="" class="btn btn-default btn-sm" title="Achats"><i class="fa fa-shopping-cart"></i></a>
                    <!--a db_id='<?php //echo $row->CLI_ID ?>' href="#delete" class="btn btn-default btn-sm btn_delete" title="Supprimer"><i class="glyphicon glyphicon-remove"></i></a-->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="myModalLabel">Ajouter un client</h5>
                    </div>

                    <div class="modal-body">
                        <div id='ret'></div>
                        <?php echo form_open_multipart('clientlist/add_client', array('class' => 'form-horizontal'));?>
                        <!--form class="form-horizontal" role="form" id="addItem" action="<?php //echo base_url().'clientlist/add_client' ?>" method="POST" enctype="multipart/form-data"-->
                          ...
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Téléphone 1</label>
                              <div class="col-sm-9">
                                 <input type="text" class="form-control" name="tel1" id="tel1" placeholder="Téléphone">
                              </div>
                          </div>

                          <div class="form-group">
                              <label class="col-sm-3 control-label">Téléphone 2</label>
                              <div class="col-sm-9">
                                 <input type="text" class="form-control" name="tel2" id="tel2" placeholder="Téléphone 2">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                 <input type="text" class="form-control" name="whatsapp" id="whatsapp" placeholder="Numéro WhatsApp">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-3 control-label" for="exampleInputFile">Photo</label>
                              <div class="col-sm-9">
                                <input id="exampleInputFile" type="file" class="form-control" name="photo" id="photo" placeholder="Charger une photo">
                              </div>
                            </div>
                            <div class="form-group">
...
$('.btn_delete').on('click', function(e) {
        ...
        var delfun = function(){
            var url = '<?php echo base_url() ?>clientlist/delete_client';
            var data = delid
            $.ajax({
                url: url,
                type:"POST",
