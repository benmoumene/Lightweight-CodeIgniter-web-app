    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       <li><a href="<?php echo base_url().'dashbord'?>">Tableau de bord</a></li>
            <li class=""><a href="<?php echo base_url().'categorielist'?>">Liste des categories</a></li></li>
            <li class="active">Modifier categorie</li>
      </ol>
	  <div id="ret" style="margin-top:20px;">
		...
		<div class="col-md-12 column">
                    <form class="form-horizontal" role="form" id="editItem" action="<?php echo base_url().'categorielist/do_edit' ?>" method="POST">
                        ...
                        <div class="form-group">
                              <label class="col-sm-3 control-label">Nom categorie</label>
                              <div class="col-sm-9">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
							  <input type="text" class="form-control" name="prenoms" id="prenoms" value="<?=$row->prenom?>">
                              </div>
                            </div>
							 <div class="form-group">
                              <label class="col-sm-3 control-label">Téléphone 1</label>
                              <div class="col-sm-9">
							  <input type="text" class="form-control" name="telephone1" id="telephone1" value="<?=$row->telephone1?>">
                              </div>
                            </div>
							 <div class="form-group">
                              <label class="col-sm-3 control-label">Téléphone 2</label>
                              <div class="col-sm-9">
							  <input type="text" class="form-control" name="telephone2" id="telephone2" value="<?=$row->telephone2?>">
                              </div>
                            </div>
