        ...
        <div class="thumbnail btn btn-primary">
            ...
            <div class="caption">
                ...
                <b> 
                    ...
                    We suggest <a href="<?php echo base_url() ?>home/">
export excel</a> file before Reset process ! thanks
                </b>
                </p>
                <p>
                ...
                <h3>
                    ...
                    <p>
                        <b>  After reset process all the item and also transaction will be deleted.<br>
                            ...
                            We suggest <a href="<?php echo base_url() ?>articlelist/">export excel</a><br> and <a href="<?php echo base_url() ?>home/">
export transaction</a> file also before Reset process ! thanks
                        </b>
                    </p>
                <p>
