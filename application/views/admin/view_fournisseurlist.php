	...
	<div class="row clearfix">
	  <div class="col-xs-12">
		...
		<div class="col-md-12 column">
                        <a id="modal-666931" href="#modal-container-666931" role="button" class="btn bg-maroon btn-flat btn-sm" data-toggle="modal"><i class="glyphicon glyphicon-plus"></i> Nouveau Fournisseur</a>&nbsp;
		...
		<div class="box">
            ...
            <th>
				...
				$sno = 1; ?>
						...
						<td>
							<h5><strong><?=$row->FOURN_NOM ?></strong></h5>
						</td>						
            <td>
              <h5><strong><?=$row->FOURN_PRENOM ?></strong></h5>
            </td>
            <td>
              <h5><strong><?=$row->FOURN_CREATED?></strong></h5>
            </td>
            <td>
              <h5><strong><?=$row->FOURN_TEL1 ?></strong></h5>
            </td>           
            <td>
              <h5><strong><?=$row->FOURN_WHATSAPP ?></strong></h5>
            </td>
            <td style="text-align: right; color:#0080ff; font-weight: bold;">
              <h5><strong><?=$row->ACHAT_TOTAL ?></strong></h5>
            </td>
            ...
            <td>
                <div class="btn-group">
                  <a  db_id ='<?php echo $row->FOURN_ID ?>' href="<?php echo base_url() ?>fournisseurlist/load_edit_view/<?=$row->FOURN_ID?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Profil"><i class="fa fa-eye"></i></a>
                    <a  db_id ='<?php echo $row->FOURN_ID ?>' href="<?php echo base_url() ?>fournisseurlist/listeachats/<?=$row->FOURN_ID?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Ventes"><i class="fa fa-money"></i></a>
                    <a  db_id ='<?php echo $row->FOURN_ID ?>' href="<?php echo base_url() ?>fournisseurlist/load_situation_view/<?=$row->FOURN_ID?>"  role="button" data-toggle="modal" class="btn btn-default btn-sm" title="Situation"><i class="fa fa-male"></i></a>
                    <a db_id='<?php echo $row->FOURN_ID ?>' href="#delete" class="btn btn-default btn-sm btn_delete" title="Supprimer"><i class="glyphicon glyphicon-remove"></i></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="myModalLabel">Ajouter un fournisseur</h5>
                    </div>

                    <div class="modal-body">
                        <div id='ret'></div>
                        
                        <form class="form-horizontal" role="form" id="addItem" action="<?php echo base_url().'clientlist/add_client' ?>" method="POST">
                          <div class="form-group">
                              <label class="col-sm-3 control-label">Nom</label>
                              <div class="col-sm-9">
                                <input type="text" class="form-control" name="nom" id="nom" placeholder="Nom du Fournisseur">
                              </div>
                            </div>
							            <div class="form-group">
...
$('.btn_delete').on('click', function(e) {
        ...
        var delfun = function(){
            var url = '<?php echo base_url() ?>fournisseurlist/delete_fournisseur';
            var data = delid
            $.ajax({
                url: url,
                type:"POST",
