...
class Achatlist extends CI_Controller {

    
        function __construct() {
            parent::__construct();
            $this->load->model('Achatlist_model');
    ...
    //$data['typevente'] = $this->db->query("SELECT id, name FROM type_vente");
      ...
      $data['listfournisseurquery'] = $this->Init_model->listFournisseur();
    ...
    function add_achat(){
      ...
      //$this->form_validation->set_rules('typeremise','Type remise','');
            /*if($this->form_validation->run()==FALSE){
                ...
                //var_dump($data);
                //exit;
                $this->Achatlist_model->add_achat($json);               
            //}                
    }
  ...
  {
    $config['base_url'] = base_url().'/achatlist/index/';
